...
const HeaderNotLogin = () => {
    ...
    <header className="bg-white sticky top-0 w-full">
        <div className="flex justify-between p-4 items-center">
            ...
            {isLoggedIn && <div><button onClick={showCartHandler} className="h-10 px-5 transition-colors duration-150 bg-gray-200 text-black rounded-lg focus:shadow-outline hover:bg-yellow-500">
